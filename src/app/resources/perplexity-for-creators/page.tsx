...
export const metadata: Metadata = {
    ...
    keywords: ['perplexity ai', 'ai video ideas', 'what is perplexity ai', 'perplexity ai search', 'perplexity ai sign in', 'ai video generator', 'perplexity ai stock', 'perplexity ai download', 'creative guide'],
    openGraph: {
        title: 'Perplexity AI for Video Creators | Guide to AI Video Ideas',
